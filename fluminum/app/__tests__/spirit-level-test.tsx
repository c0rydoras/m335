...
describe("svgRendering",()=>{
    test("svgRendering", () => {
        const tree = render(              <Svg viewBox="0 0 100 100">
            ...
            <Text textAnchor="middle" y="20" x="50">{"90°"}</Text>
            <Text textAnchor="middle" y="80" x="50">{"-90°"}</Text>
            <Text textAnchor="middle" y="50" x="20">{ "45°"}</Text>
